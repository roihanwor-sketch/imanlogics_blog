...
const SAFE_EDITORIAL_IMAGE_VAULT: SafeImage[] = [
  ...
  // --- ISLAMIC LOGIC & ACADEMIC RESEARCH (Manuscripts, Archaeology, Astronomy, Science) ---
  {
    ...
    source: 'Unsplash',
    sourceUrl: 'https://unsplash.com/photos/N_Y4f_5vUls',
    author: 'Ali Imperial',
    license: 'Unsplash License',
    licenseUrl: 'https://unsplash.com/license',
    altText: {
      id: 'Koleksi manuskrip dan lembaran bersejarah teks kitab suci dan kajian ilmiah klasik',
      en: 'Historic manuscript leaves of sacred texts and classical scholarly research',
      ar: 'مخطوطات تاريخية ونصوص تراثية كلاسيكية توثق دراسات العلوم والآثار',
    },
    placement: 'hero',
    tags: ['manuscript', 'history', 'scrolls', 'dead sea', 'archaeology', 'scripture', 'bible', 'qumran'],
  },
  {
    url: 'https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?auto=format&fit=crop&w=1600&q=80',
    source: 'Unsplash',
    sourceUrl: 'https://unsplash.com/photos/qg2P5r6F0G4',
    author: 'Levi Meir Clancy',
    license: 'Unsplash License',
    licenseUrl: 'https://unsplash.com/license',
    altText: {
      id: 'Situs bersejarah arkeologi Timur Tengah dengan lanskap peninggalan peradaban kuno',
      en: 'Middle Eastern archaeological heritage site preserving ancient historical civilizations',
      ar: 'موقع أثري تاريخي في الشرق الأوسط يوثق شواهد الحضارات والرسالات القديمة',
    },
    placement: 'breakdown',
    tags: ['archaeology', 'isa', 'prophecy', 'history', 'monotheism', 'jerusalem', 'ancient', 'middle east'],
  },
  {
