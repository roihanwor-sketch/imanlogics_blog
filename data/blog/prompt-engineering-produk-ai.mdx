...
draft: false
summary: 'Bukan sekadar menulis instruksi obrolan biasa. Artikel ini membahas disiplin rekayasa prompt (prompt engineering) untuk sistem skala produksi: bagaimana mendesain instruksi yang modular, konsisten, dan mudah dirawat.'
